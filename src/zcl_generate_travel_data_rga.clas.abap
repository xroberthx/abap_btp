CLASS zcl_generate_travel_data_rga DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_rga IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_rga.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_rga.

*   insert the new table entries
    INSERT ztravel_rga FROM TABLE @itab.
